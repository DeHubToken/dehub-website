...
const abiRewards = [
  ...
  'function calcCurrentClaimableShare(address holderAddr, uint256 stakeAmount) public view returns(uint256)',
...
(async () => {
  ...
  async function updateData() {
    ...
    claimableShare = ethers.utils.formatEther(
      await dhbRew.calcCurrentClaimableShare(signerAddr, 0)
    );
